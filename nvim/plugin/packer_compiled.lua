...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/Users/julian/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  harpoon = {
    loaded = true,
    path = "/Users/julian/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/Users/julian/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
